      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
          ...
          <div className="flex flex-col justify-start pt-0 lg:pt-8">
            <div className="mb-6">
              <h1 className='text-2xl font-semibold bg-blue-300 rounded-full px-3 py-1 w-fit'>Why Choose Us</h1>
            </div>
            ...
            <button className="inline-flex w-fit items-center gap-3 bg-blue-600 hover:bg-blue-700 text-white font-semibold px-6 py-3 rounded-full transition-all duration-300 hover:shadow-lg hover:scale-105 active:scale-95">
              Let's Talk
              <svg
                className="w-5 h-5"
                fill="none"
          ...
          <div className="relative pt-0 lg:pt-8">
            ...
            <div className="space-y-8 sm:space-y-12">
              {timelineItems.map((item) => (
                ...
                >
                  {/* Icon Circle */}
                  <div className="absolute left-0 top-2 w-12 h-12 bg-white border-2 border-slate-300 rounded-full flex items-center justify-center transition-all duration-300 hover:border-blue-500 hover:shadow-md hover:scale-110">
                    {item.icon && (
                  ...
                  {/* Content Card */}
<div className="relative bg-white rounded-lg p-6 pl-16 shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-1">                    <h3 className="text-xl font-bold text-slate-900 mb-2">
                      {item.title}
                    </h3>
